...
?>
<div style="background:#f1f1f1;width:95%;padding:10px;margin-left:auto;margin-right:auto;font-family:'Source Sans Pro',sans-serif;font-size:12pt;font-weight:300;">

	<div>
	  <div align="center"><strong>MESAFELİ SATIŞ SÖZLEŞMESİ</strong></div>
	  <div align="left">
	...
	<div style="width:98%;border:2px solid #ddd;padding-left:10px;">
		...
		<table style="width:98%;border:2px solid #ddd;padding:10px;" valign="top" border="0">
			<tr>
				<td width="100%">
					<strong>1.1. SATICI</strong> (sözleşmede bundan sonra "SATICI" olarak anılacaktır)<br />
					<div class="left" style="padding-bottom:10px;">
						<span style="font-weight:400"><b><?php echo $entry_name; ?></b></span> <?php echo $store_name; ?><br />
						<span style="font-weight:400"><b><?php echo $entry_owner; ?></b></span> <?php echo $config_owner; ?><br />
						<span style="font-weight:400"><b><?php echo $entry_address; ?></b></span> <?php echo $config_address; ?><br />
						<span style="font-weight:400"><b><?php echo $entry_email; ?></b></span> <?php echo $config_email; ?><br />
						<span style="font-weight:400"><b><?php echo $entry_telephone; ?></b></span> <?php echo $config_telephone; ?><br />
						<?php if (!empty($config_fax)) { ?><span style="font-weight:400"><b><?php echo $entry_fax; ?></b></span> <?php echo $config_fax; ?><br /><?php } ?>
					</div>
				</td>
			</tr>
			<tr>
				<td width="100%">
					...
					<div class="left">
						<span style="font-weight:400"><b><?php echo $customer_name_surname; ?></b></span> <?php echo $firstname . " " . $lastname; ?><br />
						<?php if (!empty($company)) { ?><span style="font-weight:400"><b><?php echo $customer_company; ?></b></span> <?php echo $company; ?><br /><?php } ?>
						<span style="font-weight:400"><b><?php echo $customer_address; ?></b></span> <?php echo $payment_address_1 ." ". $shipping_address_2 . "<br /> " . $payment_postcode. " ". $payment_city . "/" . $payment_country; ?><br />
						<span style="font-weight:400"><b><?php echo $customer_telephone;?></b></span> <?php echo $telephone; ?><br />
						<span style="font-weight:400"><b><?php echo $customer_email; ?></b></span> <?php echo $email; ?>  <br />  
						<div class="ipaddress">
							<?php 
							...
							echo "<span style=\"font-weight:400\"><b>".$customer_ip."</b></span> ".getRealIpAddr();
							?>
						</div>
					</div>
				</td>
		...
		<div class="clr5">
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
				<div class="table-responsive" style="padding-right:10px;">
					...
					<thead>
					  <tr>
						<td class="text-center" width="6%"><?php echo $column_image; ?></td>
		...
		<div class="clr5">
			...
			<div class="left" style="padding-left:20px;padding-bottom:5px;">
				<span style="font-weight:400"><b><?php echo $customer_name_surname; ?></b></span> <?php echo $payment_firstname . " " . $payment_lastname; ?><br />
				<?php if (!empty($payment_company)) { ?><span style="font-weight:400"><b><?php echo $customer_company; ?></b></span> <?php echo $payment_company; ?><br /><?php } ?>
				<span style="font-weight:400"><b><?php echo $customer_address; ?></b></span> <?php echo $payment_address_1 ." ". $payment_address_2 . "<br />" . $payment_postcode. " ". $payment_city . "/". $payment_zone . "/" . $payment_country; ?><br />
				<span style="font-weight:400"><b><?php echo $customer_telephone; ?></b></span> <?php echo $telephone; ?><br />
			</div>
			<p>5.2. Teslimat Bilgileri:</p>
			<div class="left" style="padding-left:20px;padding-bottom:5px;">
				<span style="font-weight:400"><b><?php echo $customer_name_surname; ?></span> <?php echo $shipping_firstname . " " . $payment_lastname; ?><br />
				<?php if (!empty($payment_company)) { ?><span style="font-weight:400"><b><?php echo $customer_company; ?></b></span> <?php echo $payment_company; ?><br /><?php } ?>
				<span style="font-weight:400"><b><?php echo $customer_address; ?></b></span> <?php echo $shipping_address_1 ." ". $shipping_address_2 . "<br />" . $shipping_postcode. " ". $shipping_city . "/". $shipping_zone . "/" . $shipping_country; ?><br />
				<span style="font-weight:400"><b><?php echo $customer_telephone; ?></b></span> <?php echo $telephone; ?><br />
			</div>			
		</div>
		...
		<div class="clr5">
			<table border="0">
				<tr height="25">
					...
					<td width="75%"><strong>:</strong> <?php echo $store_name; ?></td>
				</tr>
				<tr height="25">
